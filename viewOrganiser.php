...
<html>
    ...
    <body>
        <div class="container">
            <h3>View Organisers</h3>
            <!--<button class="btn btn-primary" id="btnAdd">Add</button>-->
            <table id="defaultTable" class="table table-bordered table-striped" cellspacing="0" width="100%">
                <tr><th>Company Name</th><th>Description</th><th>Email</th><th>Edit/Delete</th></tr>
                <?php
                $row = "";
                foreach ($arrUsers as $key => $value) {
                    $row .= "<tr><td>" . $value["username"] . "</td><td>" . $value["description"] . "</td><td>" . $value["email"] . "</td><td><button>Edit</button><br/><button>Delete</button></td><tr>";
                }
                print_r($row);
                ?>
            </table> 
